    ...
    return (
        <Container>
                ...
                <AboutContaine>
                    <AboutText>
                        {isEnglish ?
                            ...
                            I've been in this field for about 8 months, but I still don't have a significant amount of professional experience.
                            ...
                            carreira como desenvolvedor. Estou na área hà 8 meses, porém ainda não possuo muita experiência profissional nela.
                    ...
                    <AboutText>
                        {isEnglish ?
                            `The technologies I'm used to work with and have more knowledge about are: JavaScript, TypeScript, ReactNative, Node.JS, SQL and Git.`
                            :
                            `As tecnologias com as quais eu tenho maior conhecimento e costumo trabalhar são: JavaScript, TypeScript, ReactNative, Node.JS, SQL e Git.`
                        }
                    </AboutText>
                </AboutContaine>
            </TextPart>
            <ImagePart>
                ...
                {isEnglish ? <span>Send me an email ↑↑</span> : <span>Me manda um email ↑↑</span>}
            </ImagePart>
        </Container>
    )
}
